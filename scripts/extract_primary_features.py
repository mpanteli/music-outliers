...
def extract_melspectrograms(audio_file_list, output_csv_list):
    """ Extract melspectrograms for a list of audio recordings

    Parameters
    ----------
    audio_file_list : list of str
        Path to input audio files
    output_csv_list : list of str
...
def extract_chromagrams(audio_file_list, output_csv_list):
    """ Extract chromagrams for a list of audio recordings
...
def extract_melodia(audio_file_list, output_csv_list):
    """ Extract melodia estimates using the Melodia Vamp Plugin for a list of audio recordings
...
def extract_speech_music_segmentation(audio_file_list, output_csv_list):
    """ Extract speech/music segments using the SpeechMusic Vamp Plugin for a list of audio recordings
...
def extract_features_for_file_list(df, melspec=True, chroma=True, melodia=True, speech=True):
    """ Extract melspectrograms, chromagrams, melodia, and speech segments for multiple audio recordings.

    Parameters
    ----------
    df : pd.DataFrame
        Metadata for each recording including the path to audio, melspec, chroma
    melspec: boolean
        If True, melspectrograms will be extracted for each recording in df
    chroma: boolean
        If True, chromagrams will be extracted for each recording in df
    melodia: boolean
        If True, melodia will be extracted for each recording in df
    speech: boolean
        If True, speech/music segments will be extracted for each recording in df
    """
